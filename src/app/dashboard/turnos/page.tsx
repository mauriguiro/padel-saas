      ...
      <div className="bg-muted/30 p-12 rounded-3xl border shadow-sm flex flex-col items-center text-center max-w-2xl">
        <div className="relative mb-8">
          ...
          <div className="relative bg-background p-4 rounded-full border shadow-sm">
            <CalendarClock className="h-16 w-16 text-green-500" strokeWidth={1.5} />
          </div>
        ...
        <div className="flex gap-4">
          <div className="px-6 py-2 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 font-bold rounded-full text-sm border border-green-200 dark:border-green-800">
            Próximamente
          </div>
        </div>
      </div>
